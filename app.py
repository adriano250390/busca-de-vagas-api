...
def buscar_vagas(termo: str, localizacao: str = ""):
    """Busca vagas de emprego no Jooble e retorna títulos, empresas, localizações e a data da vaga."""
    ...
    if response.status_code == 200:
        ...
        for vaga in data.get("jobs", []):
            vagas.append({
                ...
                "link": vaga.get("link", "#"),
                "data_atualizacao": vaga.get("updated", "Data não informada")  # 🔵 Incluindo a data da vaga
            })
